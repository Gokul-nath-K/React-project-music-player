...
const MusicControlBar = ( {song, setcurrentSong, audioElement , isPlaying, setisplaying, currentSong, value, loopActive, setloopActive} ) => {
      ...
      <div className="music-bar-inner-container">
        <div className="row">
          <div className="col-md-4"> 
            <div className="controls">{<MediaControlCard currentSong={currentSong}/>}</div>
          </div>
          <div className="col-md-4">
